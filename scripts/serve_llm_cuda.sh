...
#   AUDIOBOOK_LLM_THINK_BUDGET  default 4096 (server default, used by the dictionary/opening
#                               step; marking/check requests override it per-request)
...
BUDGET="${AUDIOBOOK_LLM_THINK_BUDGET:-4096}"
